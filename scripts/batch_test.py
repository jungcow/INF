...
def run_batch(args, iter_num, from_lidar):
    ...
    cmd = [
        "python", "main.py",
        "--model=multicolor",
        "--yaml=color_kitti-360_cam0,color_kitti-360_cam1,color_kitti-360_cam2,color_kitti-360_cam3",
...
def main():
    ...
    print("Batch processing complete. Results saved to res_batch.json")
