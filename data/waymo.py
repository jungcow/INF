...
class Dataset(Dataset3D):
    ...
    def get_scan(self, idx: int) -> Dict[str, Any]:
        ...
        # 5th column: correspondeing channel
        ...
        if self.opt.train.use_weight:
            ...
            if os.path.exists(weight_path):
                ...
                weight = self.cal_weight(pc.numpy(), (r>0).numpy(), phi, theta, channels)
    ...
    def cal_weight(self, pointcloud: np.ndarray, filter_: np.ndarray, phi, theta, channels) -> np.ndarray:
        CHANNELS=64
        # def create_vcf_lut():
        #     """
